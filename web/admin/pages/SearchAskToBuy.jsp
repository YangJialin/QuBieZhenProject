                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputTitle"
                                                           placeholder="关键字" name="askdto.askTitle">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control" id="inputAuthor" name="askdto.userId">
...
<script>
    ...
    $(function () {
        ...
        $("#search-btm").click(function () {
            $("#body-box").show();
            $.ajax({
                url: "/admin/getAskToBuyList.action",
                type: "get",
                ...
                success: function (data) {
                    ...
                    $.each(data.askList, function (index, ask) {
                        ...
                        var trString = "<tr><td>" + ask.askId + "</td>" +
                            "<td>" + ask.askTitle + "</td>" +
                            "<td>" + ask.udto.userId + "</td>" +
                            "<td>" + ask.createTime + "</td>" +
                            "<td><a href='${pageScope.basePath}admin/getAskToBuyDetails.action?askdto.askId=" + ask.askId + "'>查看详情</a></td></tr>";
