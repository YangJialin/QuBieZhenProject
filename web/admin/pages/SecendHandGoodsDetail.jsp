                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <img class="img-responsive"
                                             src="<s:url action='viewImg'><s:param name='imgpath'>${sgdto.goodsImg}</s:param></s:url>"
                                             alt="商品图片">
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <li class="list-group-item">
                                                <p class="text-center">标题：${sgdto.goodsTitle}</p>
                                            </li>
                                            <li class="list-group-item">
                                                <p class="text-center">描述：${sgdto.goodsDescribe}</p>
                                            </li>
                                            <li class="list-group-item">
                                                <p class="text-center">类型：${sgdto.goodsType}</p>
                                            </li>
                                            <li class="list-group-item">
                                                <p class="text-center">创建时间：${sgdto.createTime}</p>
                                            </li>

                                            <li class="list-group-item">
                                                <p class="text-center">价格：￥${sgdto.goodsPrice}</p>
                                            </li>
                                            <li class="list-group-item">
                                                <p class="text-center">发布者ID：${sgdto.authorId}</p>
                                            </li>
                                            <li class="list-group-item">
                                                <p class="text-center">所在地：${sgdto.goodsLocation}</p>
                                            </li>
...
<script type="text/javascript">
    $(function () {
        var Id = ${sgdto.goodsId};
        $("#modify-btm").click(function () {
            location.href = "${pageScope.basePath}admin/pages/Modify2HandGoods.jsp?goodsId=" + Id;
        });

        $("#delete-btm").click(function () {
            if (confirm("确定删除吗？") == true) {
                location.href = "${pageScope.basePath}admin/delete2HandGoods.action?sgdto.goodsId=" + Id;
            }
        })
    })
</script>
