...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${pageScope.basePath}dist/img/user2-160x160.jpg" class="user-image"
                                 alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="${pageScope.basePath}dist/img/user2-160x160.jpg" class="img-circle"
                                     alt="User Image">
                                <p>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="${pageScope.basePath}admin/logout.action" class="btn btn-default btn-flat">登出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageScope.basePath}admin/modifyNotice.action" method="post" id="notice-form">
                            ...
                            <div class="box-body pad">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="inputTitle" class="form-control"
                                                       name="ndto.noticeTitle">
                                                <input type="text" id="createAdminId" name="ndto.createAdminId"
                                                       hidden="hidden">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="textarea" name="ndto.noticeDetails"
                                                  placeholder="公告内容" id="noticeDetails"
                                                  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="box-footer">
                                <input type="button" id="publish-btm" class="btn btn-primary pull-right" value="提交">
                            </div>
                        </div>
                    </div>
                    <!-- /.col-->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            url: "${pageScope.basePath}admin/queryNoticeByIdForModify.action",
            data: {"ndto.noticeId": noticeId},
            success: function (data) {
                var ndto = data.ndto;
                $("#inputTitle").val(ndto.noticeTitle);
                $("#createAdminId").val(ndto.createAdminId);
                $("#noticeDetails").val(ndto.noticeDetails);
            }
        })
    });
    $(function () {
