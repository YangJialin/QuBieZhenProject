                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-circle"
                                 src="<s:url action='viewImg'><s:param name='imgpath'>${askdto.udto.picImg}</s:param></s:url>"
                                 alt="User profile picture">

                            <h3 class="profile-username text-center">${askdto.udto.userName}</h3>

                            <p class="text-muted text-center">${askdto.udto.showName}</p>
                            ...
                            <p class="text-muted">${askdto.udto.province},${askdto.udto.city}, ${askdto.udto.address}</p>
                    ...
                    <div class="box box-primary">
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <h3 class="text-center">标题：${askdto.askTitle}</h3>
                            </li>
                            <li class="list-group-item">
                                <p class="text-center">
                                    创建时间：${askdto.createTime}</p>
                            </li>
                            <li class="list-group-item">
                                ${askdto.askDetails}
                            </li>
