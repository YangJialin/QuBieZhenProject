                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="${pageScope.basePath}admin/modify2HandGoods.action" method="post"
                                  class="form-horizontal" id="main-form">
                                <input type="text" id="inputGoodsId" name="sgdto.goodsId" hidden="hidden">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-5">
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="button" class="btn pull-right btn-default"
                                            onclick="location.href='/admin/pages/Search2HandGoods.jsp'">取消
                                    </button>
                                    &nbsp;
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            url: "${pageScope.basePath}admin/get2HandGoodsDetailforModify.action",
            data: {"sgdto.goodsId": Id},
            success: function (data) {
                var sgdto = data.sgdto;
                $("#inputGoodsId").val(Id);
                $("#inputTitle").val(sgdto.goodsTitle);
                $("#inputDescribe").val(sgdto.goodsDescribe);
                $("#inputType").val(sgdto.goodsType);
                $("#inputAuthor").val(sgdto.authorId);
                $("#inputPrice").val(sgdto.goodsPrice);
                var loca = sgdto.goodsLocation.split("-");
                $("#inputProvince").val(loca[0]);


                $("#inputCity option:gt(0)").remove();
                $.ajax({
                    url: "${pageScope.basePath}admin/getCity.action",
                    data: {"prdto.provinceId": loca[0]},
                    success: function (data) {
    ...
    $(function () {
        ...
        $("#cancel-btm").click(function () {
            location.href("/admin/pages/Search2HandGoods.jsp");
        })
