                            ...
                            <form id="main-form" class="form-horizontal">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="inputTitle" class="col-sm-3 control-label">订单编号:</label>

                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="inputTitle"
                                                           placeholder="订单编号" name="orderdto.orderId">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="inputType" class="col-sm-3 control-label">订单状态:</label>
                                                <div class="col-sm-6">
                                                    <select class="form-control" id="inputType"
                                                            name="orderdto.orderStatus">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data.orderList, function (index, order) {
                        ...
                        var orderString = "<tr><td>" + order.orderId + "</td>" +
                            "<td>" + order.userId + "</td>" +
                            "<td>" + order.createTime + "</td>" +
                            "<td>" + order.completeTime + "</td>" +
                            "<td>" + order.sumPrice + "</td>" +
                            "<td>" + status + "</td>" +
                            "<td><a href='${pageScope.basePath}admin/getOrderDetail.action?orderdto.orderId=" + order.orderId + "'>查看详情</a></td></tr>";
                        $("#table").append(orderString);
                    })
                }, error: function () {
                    $("#table tr:gt(0)").remove();
                    $("#table").append("<tr><th colspan='7' style='color: red;text-align:center;'>查询无结果</th></tr>")
                }
