                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form action="${pageScope.basePath}admin/modifyUser.action" method="post"
                                  enctype="multipart/form-data" class="form-horizontal" id="main-form">
                                <input id="userId" name="udto.userId" hidden>
                                <div class="box-body">

                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="userPIC" class="col-sm-3 control-label">用户头像:</label>

                                                <div class="col-sm-9">
                                                    <img id="userPIC" class="profile-user-img img-responsive img-circle"
                                                         src=""
                                        ...
                                        <div class="row"></div>
                                        <div class="col-md-5">
                                            <label for="userPIC" class="col-sm-3 control-label">修改:</label>
                                            <div class="form-group">
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="password" class="form-control" id="inputPassword"
                                                           placeholder="密码" name="udto.password">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="inputScore" class="col-sm-3 control-label">积分:</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="inputScore"
                                                           placeholder="积分" name="udto.score">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control" id="inputAU"
                                                        ...
                                                        <option selected="selected" value="0">未认证</option>
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="button" class="btn pull-right btn-default" id="cancel-btm">取消</button>&nbsp;
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                var udto = data.udto;
                $("#userId").val(udto.userId);
                $("#inputEmail").val(udto.email);
                $("#inputPassword").val(udto.password);
                $("#inputUserName").val(udto.userName);
                $("#inputShowName").val(udto.showName);
                $("#inputSex").val(udto.sex);
                $("#birthday").val(udto.birthday);
                $("#inputMobile").val(udto.mobile);
                $("#inputScore").val(udto.score);
                $("#inputAU").val(udto.isAuthentication);
                $("#inputAV").val(udto.isAvalible);
                ...
                $("#userPIC").attr("src", "viewImg.action?imgpath=" + udto.picImg);
            }
        })
    });
    ...
    $(function () {
        ...
        $("#cancel-btm").click(function () {
            location.href("/admin/pages/UserSearch.jsp");
        })
