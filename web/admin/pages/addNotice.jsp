...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageScope.basePath}admin/addNotice.action" method="post" id="notice-form">
                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="ndto.noticeTitle">
                            ...
                            <div class="box-footer">
                                <input type="button" id="publish-btm" class="btn btn-primary pull-right" value="发布">
                            </div>
                        </div>
                    </div>
                    <!-- /.col-->
...
<script type="text/javascript">
    $(document).ready(function () {
        var id = "${session.admin.adminId}";
        $("#createAdminId").val(id);
