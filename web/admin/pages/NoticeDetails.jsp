                                    ...
                                    <div class="col-md-12">
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <li class="list-group-item">
                                                <h3 class="text-center">标题：${ndto.noticeTitle}</h3>
                                            </li>
                                            <li class="list-group-item">
                                                <p class="text-center">
                                                    创建时间：${ndto.createTime}&nbsp;发布者：${ndto.createAdminId}</p>
                                            </li>
                                        </ul>
                                        ${ndto.noticeDetails}
                                    </div>
...
<script type="text/javascript">
    $(function () {
        var Id = ${ndto.noticeId};
        $("#modify-btm").click(function () {
            location.href = "${pageScope.basePath}admin/pages/ModifyNotice.jsp?noticeId=" + Id;
        });

        $("#delete-btm").click(function () {
            if (confirm("确定删除吗？") == true) {
                location.href = "${pageScope.basePath}admin/deleteNotice.action?ndto.noticeId=" + Id;
            }
        })
    })
</script>
